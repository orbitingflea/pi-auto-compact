...
and session-resume compactions, this extension sends a hidden custom follow-up
...
| Auto-continue | No | Yes — replays the original prompt for pre-turn compaction; otherwise sends a hidden custom follow-up nudge |
